...
import CodeReview from './pages/deploy/review';
import SvnRequest from './pages/deploy/svnRequest';
...
export default [
  ...
  },
  {
    icon: <FlagOutlined />, title: '应用发布', auth: 'deploy.app.view|deploy.repository.view|deploy.request.view', child: [
      ...
      // { title: '代码审核', auth: 'deploy.request.view', path: '/deploy/review', component: CodeReview },
      { title: 'SVN发布', auth: 'deploy.request.view', path: '/deploy/svn/request', component: SvnRequest },
    ]
  },
  {
